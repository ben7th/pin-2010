...
processor_pid=/web/2010/pids/feed_operation_queue_worker.pid

runner_rb=$self_dir/sites/pin-user-auth/script/runner

worker_rb=$self_dir/sites/pin-user-auth/script/feed_operation_queue_worker.rb

log_path=/web/2010/logs/feed_operation_queue_worker.log
