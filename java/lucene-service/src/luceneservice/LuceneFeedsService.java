...
public class LuceneFeedsService {
  ...
  public interface AsyncIface {
    ...
    public void index_one_feed(int feed_id, AsyncMethodCallback<AsyncClient.index_one_feed_call> resultHandler) throws TException;

    public void delete_index(int feed_id, AsyncMethodCallback<AsyncClient.delete_index_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public void send_index_one_feed(int feed_id) throws TException
    {
      oprot_.writeMessageBegin(new TMessage("index_one_feed", TMessageType.CALL, ++seqid_));
      index_one_feed_args args = new index_one_feed_args();
    ...
    public boolean recv_index_one_feed() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "index_one_feed failed: out of sequence response");
      }
      index_one_feed_result result = new index_one_feed_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "index_one_feed failed: unknown result");
    }
    ...
    public void send_delete_index(int feed_id) throws TException
    {
    ...
    public String recv_search_by_user() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "search_by_user failed: out of sequence response");
      }
    ...
    public String recv_search_page_by_user() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "search_page_by_user failed: out of sequence response");
      }
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "search_page_by_user failed: unknown result");
    }
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void index_one_feed(int feed_id, AsyncMethodCallback<index_one_feed_call> resultHandler) throws TException {
      checkReady();
      index_one_feed_call method_call = new index_one_feed_call(feed_id, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class index_one_feed_call extends TAsyncMethodCall {
      private int feed_id;
      public index_one_feed_call(int feed_id, AsyncMethodCallback<index_one_feed_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.feed_id = feed_id;
      }

      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("index_one_feed", TMessageType.CALL, 0));
        index_one_feed_args args = new index_one_feed_args();
        args.setFeed_id(feed_id);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public boolean getResult() throws TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_index_one_feed();
      }
    }

    public void delete_index(int feed_id, AsyncMethodCallback<delete_index_call> resultHandler) throws TException {
      checkReady();
      delete_index_call method_call = new delete_index_call(feed_id, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class delete_index_call extends TAsyncMethodCall {
      private int feed_id;
      public delete_index_call(int feed_id, AsyncMethodCallback<delete_index_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.feed_id = feed_id;
      }
    ...
    public static class search_by_user_call extends TAsyncMethodCall {
      ...
      public String getResult() throws TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_search_by_user();
      }
    }
    ...
    public static class search_page_by_user_call extends TAsyncMethodCall {
      private String query;
      private int start;
      private int count;
      private String email;
      ...
      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("search_page_by_user", TMessageType.CALL, 0));
        search_page_by_user_args args = new search_page_by_user_args();
        args.setQuery(query);
        args.setStart(start);
        args.setCount(count);
      ...
      public String getResult() throws TException {
        ...
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_search_page_by_user();
      }
    }
  ...
  public static class Processor implements TProcessor {
    ...
    public Processor(Iface iface)
    {
      ...
      processMap_.put("index_one_feed", new index_one_feed());
      ...
      processMap_.put("search_by_user", new search_by_user());
      processMap_.put("search_page_by_user", new search_page_by_user());
    ...
    private class index_one_feed implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        index_one_feed_args args = new index_one_feed_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("index_one_feed", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        iprot.readMessageEnd();
        index_one_feed_result result = new index_one_feed_result();
        result.success = iface_.index_one_feed(args.feed_id);
        result.setSuccessIsSet(true);
        oprot.writeMessageBegin(new TMessage("index_one_feed", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
    ...
    private class delete_index implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        ...
        iprot.readMessageEnd();
        delete_index_result result = new delete_index_result();
        result.success = iface_.delete_index(args.feed_id);
        result.setSuccessIsSet(true);
    ...
    private class search_by_user implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        search_by_user_args args = new search_by_user_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("search_by_user", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
    ...
    private class search_page_by_user implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        search_page_by_user_args args = new search_page_by_user_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("search_page_by_user", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
...
;
  ...
  public static class index_one_feed_args implements TBase<index_one_feed_args, index_one_feed_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("index_one_feed_args");

    private static final TField FEED_ID_FIELD_DESC = new TField("feed_id", TType.I32, (short)1);
    ...
    // isset id assignments
    private static final int __FEED_ID_ISSET_ID = 0;
    private BitSet __isset_bit_vector = new BitSet(1);

    public static final Map<_Fields, FieldMetaData> metaDataMap;
    static {
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.FEED_ID, new FieldMetaData("feed_id", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.I32)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(index_one_feed_args.class, metaDataMap);
    }

    public index_one_feed_args() {
    }
      ...
      int feed_id)
    {
      this();
      this.feed_id = feed_id;
      setFeed_idIsSet(true);
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public index_one_feed_args(index_one_feed_args other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      this.feed_id = other.feed_id;
    }

    public index_one_feed_args deepCopy() {
      return new index_one_feed_args(this);
    }

    @Override
    public void clear() {
      setFeed_idIsSet(false);
      this.feed_id = 0;
    }
    ...
    public index_one_feed_args setFeed_id(int feed_id) {
      this.feed_id = feed_id;
      setFeed_idIsSet(true);
      return this;
    }
    ...
    public void unsetFeed_id() {
      __isset_bit_vector.clear(__FEED_ID_ISSET_ID);
    }

    /** Returns true if field feed_id is set (has been asigned a value) and false otherwise */
    public boolean isSetFeed_id() {
      return __isset_bit_vector.get(__FEED_ID_ISSET_ID);
    }

    public void setFeed_idIsSet(boolean value) {
      __isset_bit_vector.set(__FEED_ID_ISSET_ID, value);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof index_one_feed_args)
        return this.equals((index_one_feed_args)that);
      return false;
    }

    public boolean equals(index_one_feed_args that) {
      if (that == null)
        return false;

      boolean this_present_feed_id = true;
      boolean that_present_feed_id = true;
      if (this_present_feed_id || that_present_feed_id) {
        if (!(this_present_feed_id && that_present_feed_id))
          return false;
        if (this.feed_id != that.feed_id)
          return false;
      }
    ...
    public int compareTo(index_one_feed_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      index_one_feed_args typedOther = (index_one_feed_args)other;
      ...
      if (isSetFeed_id()) {
        lastComparison = TBaseHelper.compareTo(this.feed_id, typedOther.feed_id);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("index_one_feed_args(");
      boolean first = true;
  ...
  public static class index_one_feed_result implements TBase<index_one_feed_result, index_one_feed_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("index_one_feed_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.BOOL)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(index_one_feed_result.class, metaDataMap);
    }

    public index_one_feed_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public index_one_feed_result(index_one_feed_result other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      this.success = other.success;
    }

    public index_one_feed_result deepCopy() {
      return new index_one_feed_result(this);
    }
    ...
    public index_one_feed_result setSuccess(boolean success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof index_one_feed_result)
        return this.equals((index_one_feed_result)that);
      return false;
    }

    public boolean equals(index_one_feed_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(index_one_feed_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      index_one_feed_result typedOther = (index_one_feed_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("index_one_feed_result(");
      boolean first = true;
  ...
  public static class delete_index_args implements TBase<delete_index_args, delete_index_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public delete_index_args setFeed_id(int feed_id) {
      this.feed_id = feed_id;
      setFeed_idIsSet(true);
      return this;
    }
  ...
  public static class search_by_user_args implements TBase<search_by_user_args, search_by_user_args._Fields>, java.io.Serializable, Cloneable   {
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public search_by_user_args(search_by_user_args other) {
      if (other.isSetQuery()) {
        this.query = other.query;
      }
      if (other.isSetEmail()) {
    ...
    public search_by_user_args deepCopy() {
      return new search_by_user_args(this);
    }
    ...
    public search_by_user_args setQuery(String query) {
      this.query = query;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof search_by_user_args)
        return this.equals((search_by_user_args)that);
      return false;
    }

    public boolean equals(search_by_user_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(search_by_user_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      search_by_user_args typedOther = (search_by_user_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("search_by_user_args(");
      boolean first = true;
  ...
  public static class search_by_user_result implements TBase<search_by_user_result, search_by_user_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("search_by_user_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(search_by_user_result.class, metaDataMap);
    }

    public search_by_user_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public search_by_user_result(search_by_user_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public search_by_user_result deepCopy() {
      return new search_by_user_result(this);
    }
    ...
    public search_by_user_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof search_by_user_result)
        return this.equals((search_by_user_result)that);
      return false;
    }

    public boolean equals(search_by_user_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(search_by_user_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      search_by_user_result typedOther = (search_by_user_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("search_by_user_result(");
      boolean first = true;
  ...
  public static class search_page_by_user_args implements TBase<search_page_by_user_args, search_page_by_user_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("search_page_by_user_args");
    ...
    public search_page_by_user_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public search_page_by_user_args(search_page_by_user_args other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      if (other.isSetQuery()) {
        this.query = other.query;
    ...
    public search_page_by_user_args deepCopy() {
      return new search_page_by_user_args(this);
    }
    ...
    public search_page_by_user_args setQuery(String query) {
      this.query = query;
      return this;
    }
    ...
    public search_page_by_user_args setStart(int start) {
      this.start = start;
      setStartIsSet(true);
      return this;
    }
    ...
    public search_page_by_user_args setCount(int count) {
      this.count = count;
      setCountIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof search_page_by_user_args)
        return this.equals((search_page_by_user_args)that);
      return false;
    }

    public boolean equals(search_page_by_user_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(search_page_by_user_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      search_page_by_user_args typedOther = (search_page_by_user_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("search_page_by_user_args(");
      boolean first = true;
  ...
  public static class search_page_by_user_result implements TBase<search_page_by_user_result, search_page_by_user_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("search_page_by_user_result");
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(search_page_by_user_result.class, metaDataMap);
    }

    public search_page_by_user_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public search_page_by_user_result(search_page_by_user_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public search_page_by_user_result deepCopy() {
      return new search_page_by_user_result(this);
    }
    ...
    public search_page_by_user_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof search_page_by_user_result)
        return this.equals((search_page_by_user_result)that);
      return false;
    }

    public boolean equals(search_page_by_user_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(search_page_by_user_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      search_page_by_user_result typedOther = (search_page_by_user_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("search_page_by_user_result(");
      boolean first = true;
