...
public class LuceneMindmapsService {
  ...
  public interface AsyncIface {
    ...
    public void search_by_user(String query, int user_id, AsyncMethodCallback<AsyncClient.search_by_user_call> resultHandler) throws TException;

    public void search_page_by_user(String query, int start, int count, int user_id, AsyncMethodCallback<AsyncClient.search_page_by_user_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public void send_search_by_user(String query, int user_id) throws TException
    {
    ...
    public void send_search_page_by_user(String query, int start, int count, int user_id) throws TException
    {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void search_by_user(String query, int user_id, AsyncMethodCallback<search_by_user_call> resultHandler) throws TException {
      checkReady();
      search_by_user_call method_call = new search_by_user_call(query, user_id, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }
    ...
    public static class search_by_user_call extends TAsyncMethodCall {
      private String query;
      private int user_id;
      public search_by_user_call(String query, int user_id, AsyncMethodCallback<search_by_user_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
    ...
    public void search_page_by_user(String query, int start, int count, int user_id, AsyncMethodCallback<search_page_by_user_call> resultHandler) throws TException {
      checkReady();
      search_page_by_user_call method_call = new search_page_by_user_call(query, start, count, user_id, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }
    ...
    public static class search_page_by_user_call extends TAsyncMethodCall {
      ...
      private int count;
      private int user_id;
      public search_page_by_user_call(String query, int start, int count, int user_id, AsyncMethodCallback<search_page_by_user_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
        this.start = start;
        this.count = count;
  ...
  public static class Processor implements TProcessor {
    ...
    private class search_by_user implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        ...
        iprot.readMessageEnd();
        search_by_user_result result = new search_by_user_result();
        result.success = iface_.search_by_user(args.query, args.user_id);
    ...
    private class search_page_by_user implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        ...
        iprot.readMessageEnd();
        search_page_by_user_result result = new search_page_by_user_result();
        result.success = iface_.search_page_by_user(args.query, args.start, args.count, args.user_id);
...
;
  ...
  public static class search_by_user_args implements TBase<search_by_user_args, search_by_user_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final TField QUERY_FIELD_DESC = new TField("query", TType.STRING, (short)1);
    private static final TField USER_ID_FIELD_DESC = new TField("user_id", TType.I32, (short)2);
    ...
    public search_by_user_args setUser_id(int user_id) {
      this.user_id = user_id;
      setUser_idIsSet(true);
      return this;
    }
  ...
  public static class search_page_by_user_args implements TBase<search_page_by_user_args, search_page_by_user_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final TField START_FIELD_DESC = new TField("start", TType.I32, (short)2);
    private static final TField COUNT_FIELD_DESC = new TField("count", TType.I32, (short)3);
    private static final TField USER_ID_FIELD_DESC = new TField("user_id", TType.I32, (short)4);
    ...
    public search_page_by_user_args setUser_id(int user_id) {
      this.user_id = user_id;
      setUser_idIsSet(true);
      return this;
    }
