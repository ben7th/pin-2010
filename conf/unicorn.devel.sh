...
user_auth_dir=/web1/pin-2010/sites/pin-user-auth
user_auth_pid=/web/2010/pids/unicorn-user-auth.pid

workspace_dir=/web1/pin-2010/sites/pin-workspace
workspace_pid=/web/2010/pids/unicorn-workspace.pid

discuss_dir=/web1/pin-2010/sites/pin-discuss
discuss_pid=/web/2010/pids/unicorn-discuss.pid

bug_dir=/web1/pin-2010/sites/pin-bugs
bug_pid=/web/2010/pids/unicorn-bugs.pid

share_dir=/web1/pin-2010/sites/pin-share
share_pid=/web/2010/pids/unicorn-share.pid


mindmap_image_cache_dir=/web1/pin-2010/apps/app-mindmap-image-cache
mindmap_image_cache_pid=/web/2010/pids/unicorn-mindmap-image-cache.pid

website_dir=/web1/pin-2010/sites/pin-website
...
mev6_dir=/web1/pin-2010/sites/pin-mev6
...
. /etc/rc.status
  ...
  case "$1" in
    ...
    *)
    echo "$1"
    echo "tip:(config|user|workspace|discuss|bug|share|mindmap_editor|mindmap_image_cache|website|notes|mev6)"
    exit 5
    ;;
  esac
