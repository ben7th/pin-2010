...
processor_pid=/web/2010/pids/synchronous_message_from_tsina_worker.pid

runner_rb=$self_dir/../../sites/pin-user-auth/script/runner

mq_rb=$self_dir/../../sites/pin-user-auth/script/synchronous_message_from_tsina_worker.rb

log_path=/web/2010/logs/synchronous_message_from_tsina_worker.log
