...
pie.mindmap.NodeImageEditor = Class.create({
  ...
  _bind_button_event:function(){
    if(!this.image_event_loaded){
      $('load_img').observe("click",this._do_load_image.bind(this));
      $("accept_img").observe("click",this._do_accept_image.bind(this));
      this.image_event_loaded = true;
    }
  },

  _do_load_image:function(){
