ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :mindmaps,:collection=>{:import=>:get,:mine=>:get,:tags=>:get},
    :member=>{:convert_bundle=>:put,:toggle_private=>:put,:export=>:get,:clone=>:put,:outline=>:get,:rate=>:put,:setnote=>:post,:paramsedit=>:get,:widget=>:get,:quote=>:get,:reimport=>:get,:neweditor=>:get} do |mindmap|
