class MindmapFav < ActiveRecord::Base
  ...
  module UserMethods
    def self.included(base)
      ...
      base.has_many :fav_mindmaps_db,:through=>:mindmap_favs,:source=>:mindmap,:order=>"updated_at desc"
    end
  ...
  include MindmapFavProxy::MindmapFavMethods
